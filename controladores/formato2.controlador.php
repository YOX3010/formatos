...
class ControladorFormato2
{
	...
	// static public function ctrCrearFormato2()
	// {
	...
	static public function ctrMostrarFormato2($item, $valor)
	{
	...
	static public function ctrEditarFormato2()
	{
		...
		if (isset($_POST["editarFormato2"])) {
			...
			$datos = array(
				...
				"id_imagenes_cliente" => $_POST["editarIdImagenesCliente"],
				"id" => $_POST["idFormato2"]
			);
