...
class ControladorCotizaciones{
		...
		if(isset($_POST["nuevaVenta"])){
			...
			foreach ($listaProductos as $key => $value) {
			   ...
			   $tablaProductos = "productos";
			    ...
			    $traerProducto = ModeloReparaciones::mdlMostrarReparaciones($tablaProductos, $item, $valor, $orden);

				$item1a = "ventas";
				$valor1a = $value["cantidad"] + $traerProducto["ventas"];

			    $nuevasVentas = ModeloReparaciones::mdlActualizarReparacion($tablaProductos, $item1a, $valor1a, $valor);

				$item1b = "stock";
				$valor1b = $value["stock"];

				$nuevoStock = ModeloReparaciones::mdlActualizarReparacion($tablaProductos, $item1b, $valor1b, $valor);
	...
	static public function ctrEditarCotizacion(){
		...
		if(isset($_POST["editarVenta"])){
			...
			$traerVenta = ModeloCotizaciones::mdlMostrarCotizaciones($tabla, $item, $valor);
			...
			if($cambioProducto){
				...
				foreach ($listaProductos_2 as $key => $value) {
					...
					$tablaProductos_2 = "reparaciones";

					$item_2 = "id";
					$valor_2 = $value["id"];
					$orden = "id";

					$traerProducto_2 = ModeloReparaciones::mdlMostrarReparaciones($tablaProductos_2, $item_2, $valor_2, $orden);

					$item1a_2 = "ventas";
					$valor1a_2 = $value["cantidad"] + $traerProducto_2["ventas"];

					$nuevasVentas_2 = ModeloReparaciones::mdlActualizarReparacion($tablaProductos_2, $item1a_2, $valor1a_2, $valor_2);

					$item1b_2 = "stock";
					$valor1b_2 = $traerProducto_2["stock"] - $value["cantidad"];

					$nuevoStock_2 = ModeloReparaciones::mdlActualizarReparacion($tablaProductos_2, $item1b_2, $valor1b_2, $valor_2);
	...
	static public function ctrEliminarCotizacion(){
		...
		if(isset($_GET["idVenta"])){
			...
			$traerVentas = ModeloCotizaciones::mdlMostrarCotizaciones($tabla, $itemVentas, $valorVentas);
			...
			$respuesta = ModeloCotizaciones::mdlEliminarCotizacion($tabla, $_GET["idVenta"]);
	...
	public function ctrDescargarReporte(){
		...
		if(isset($_GET["reporte"])){
			...
			if(isset($_GET["fechaInicial"]) && isset($_GET["fechaFinal"])){
				...
				$ventas = ModeloCotizaciones::mdlRangoFechasCotizaciones($tabla, $_GET["fechaInicial"], $_GET["fechaFinal"]);
				...
				$ventas = ModeloCotizaciones::mdlMostrarCotizaciones($tabla, $item, $valor);
	...
	static public function ctrSumaTotalCotizaciones(){
