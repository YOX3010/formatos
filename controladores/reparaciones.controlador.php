...
class ControladorReparaciones{
	...
	static public function ctrMostrarReparaciones($item, $valor, $orden){

		$tabla = "reparaciones";

		$respuesta = ModeloReparaciones::mdlMostrarReparaciones($tabla, $item, $valor, $orden);
		...
		if(isset($_POST["nuevaDescripcion"])){
			...
			if(preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["nuevaDescripcion"]) &&
			   ...
			   preg_match('/^[0-9.]+$/', $_POST["nuevoPrecioVenta"])){
				...
				$respuesta = ModeloReparaciones::mdlIngresaReparaciones($tabla, $datos);
