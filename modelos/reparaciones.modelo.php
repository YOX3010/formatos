...
class ModeloReparaciones{
	...
	static public function mdlMostrarReparaciones($tabla, $item, $valor, $orden){
	...
	static public function mdlActualizarReparacion($tabla, $item1, $valor1, $valor){
	...
	static public function mdlMostrarSumaReparaciones($tabla){
