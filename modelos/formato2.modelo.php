...
class ModeloFormato2
{
    ...
    public static function mdlEditarFormato2($tabla, $datos)
    {
        ...
        $stmt = Conexion::conectar()->prepare("UPDATE $tabla 	SET 	bank_name 	= :bank_name,
																		branch_address = :branch_address,
																		banking_official_name 	= :banking_official_name,
							   											phone_number = :phone_number,
							   											fax_number = :fax_number,
							   											banking_oficer_mail = :banking_oficer_mail,
							   											account_signatory_name = :account_signatory_name,
							   											account_name = :account_name,
							   											account_number_routing_aba = :account_number_routing_aba,
							   											...
							   											title_corporation_company = :title_corporation_company,
