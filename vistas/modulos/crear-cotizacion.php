    ...
    <div class="row">
      ...
      <div class="col-lg-5 col-xs-12">        
              ...
              <div class="box">
                ...
                <div class="form-group">                  
                  ...
                  <div class="input-group">                    
                    ...
                    $ventas = ControladorCotizaciones::ctrMostrarCotizaciones($item, $valor);
                  ...
                  <div class="col-xs-6" style="padding-right:0px">                    
                     ...
                     <div class="input-group">                  
                      ...
                      <select class="form-control" id="nuevoMetodoPago" name="nuevoMetodoPago" required>
                        ...
                        <option value="CXC">Cuenta x Cobrar</option>                   
        ...
        <?php
          ...
          $guardarVenta = new ControladorCotizaciones();
          $guardarVenta -> ctrCrearCotizacion();          
