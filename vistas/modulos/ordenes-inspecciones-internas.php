...
<div class="content-wrapper">
  ...
  <section class="content-header">    
    ...
    <h1> Administrar Inspeccion Interna </h1>

    <ol class="breadcrumb">      

      <li><a href="inicio"><i class="fa fa-dashboard"></i> Inicio</a></li>      

      <li class="active">Administrar Inspeccion Interna</li>    
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <a href="index.php?ruta=ordenes-inspecciones-internas&idOrdenInspeccionInterna=<?php echo $_GET['idOrdenInspeccionInterna']; ?>">
      ...
      <div class="box-body">        
       ...
       <table class="table table-bordered table-striped dt-responsive tablas" width="100%">         
        ...
        <?php
          ...
          $orden = ControladorOrdenesInspeccionesInternas::ctrMostrarOrdenesInspeccionesInternas($item, $valor);          

          foreach ($orden as $key => $value) { 

            if ($value["id_orden"] == $_GET['idOrdenInspeccionInterna']) {
          ...
          //$Key = 0;          
            ...
            echo ' <tr>
                    ...
                    if ($value["id_elemento"] > 0) {
                      ...
                      $respuestaElemento = ControladorInspeccionesInternas::ctrMostrarInspeccionesInternas($itemElemento, $valorElemento);
                    ...
                    <td>
                      ...
                      <button class="btn btn-info btnEditarOrdenInspeccion" idOrdenInspeccion="'.$value["id_orden"].'"><i class="fa-regular fa-circle-left"></i></button>                          
                       ...
                       <button class="btn btn-warning btnEditarOrdenInspeccionInterna" idOrdenInspeccionInterna="'.$value["id"].'" data-toggle="modal" data-target="#modalEditarOrdenInspeccionInterna"><i class="fa fa-pencil"></i></button>';
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
          ...
          <div class="box-body">           
            ...
            <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <?php
                      ...
                      $elemento = ControladorInspeccionesInternas::ctrMostrarInspeccionesInternas($item, $valor);
            ...
            <div class="form-group">              
              ...
              <div class="input-group">              
               ...
               <input type="hidden"  name="idOrdenInspeccionInterna" id="idOrdenInspeccionInterna" required>
 
                <input type="hidden"  name="editarOrdenInspeccionInterna" id="editarOrdenInspeccionInterna" required>
      ...
      <?php
          ...
          $editarOrdenInspeccionInterna = new ControladorOrdenesInspeccionesInternas();
          $editarOrdenInspeccionInterna -> ctrEditarOrdenInspeccionInterna();
...
<!--=====================================
MODAL AGREGAR ELEMENTO INSPECCION INTERNA
======================================-->
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
          ...
          <div class="box-body">           
            ...
            <div class="form-group">              
              ...
              <div class="input-group">              
                ...
                <input type="text" class="form-control input-lg" name="nuevoObservacion" placeholder="Ingresar Observacion" required>

                <input type="hidden" class="form-control" name="nuevoOrdenInspeccionInterna" value="<?php echo $_GET['idOrdenInspeccionInterna']; ?>" readonly>
      ...
      <?php
          ...
          $crearOrdenInspeccionInterna = new ControladorOrdenesInspeccionesInternas();
          $crearOrdenInspeccionInterna -> ctrCrearOrdenInspeccionInterna();
