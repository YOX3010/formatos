...
<div class="content-wrapper">
  ...
  <section class="content-header">    
    ...
    <h1> Administrar Inspeccion Neumatico</h1>

    <ol class="breadcrumb">      

      <li><a href="inicio"><i class="fa fa-dashboard"></i> Inicio</a></li>      

      <li class="active">Administrar Inspeccion Neumatico</li>    
  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <a href="index.php?ruta=ordenes-inspecciones-neumaticos&idOrdenInspeccionNeumatico=<?php echo $_GET['idOrdenInspeccionNeumatico']; ?>">
      ...
      <div class="box-body">        
       ...
       <table class="table table-bordered table-striped dt-responsive tablas" width="100%">         
        ...
        <?php
          ...
          $orden = ControladorOrdenesInspeccionesNeumaticos::ctrMostrarOrdenesInspeccionesNeumaticos($item, $valor);          

          foreach ($orden as $key => $value) { 

            if ($value["id_orden"] == $_GET['idOrdenInspeccionNeumatico']) {
          ...
          //$Key = 0;          
            ...
            echo ' <tr>
                    ...
                    if ($value["id_elemento"] > 0) {
                      ...
                      $respuestaElemento = ControladorInspeccionesNeumaticos::ctrMostrarInspeccionesNeumaticos($itemElemento, $valorElemento);
                    ...
                    <td>
                      ...
                      <button class="btn btn-info btnEditarOrdenInspeccion" idOrdenInspeccion="'.$value["id_orden"].'"><i class="fa-regular fa-circle-left"></i></button>                          
                       ...
                       <button class="btn btn-warning btnEditarOrdenInspeccionNeumatico" idOrdenInspeccionNeumatico="'.$value["id"].'" data-toggle="modal" data-target="#modalEditarOrdenInspeccionNeumatico"><i class="fa fa-pencil"></i></button>';
...
<!--=====================================
MODAL EDITAR ORDEN INSPECCION NEUMATICO
======================================-->

<div id="modalEditarOrdenInspeccionNeumatico" class="modal fade" role="dialog">  
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
          ...
          <div class="box-body">           
            ...
            <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <?php
                      ...
                      $elemento = ControladorInspeccionesNeumaticos::ctrMostrarInspeccionesNeumaticos($item, $valor);
            ...
            <div class="form-group">              
              ...
              <div class="input-group">              
               ...
               <input type="hidden"  name="idOrdenInspeccionNeumatico" id="idOrdenInspeccionNeumatico" required>
 
                <input type="hidden"  name="editarOrdenInspeccionNeumatico" id="editarOrdenInspeccionNeumatico" required>
      ...
      <?php
          ...
          $editarOrdenInspeccionNeumatico = new ControladorOrdenesInspeccionesNeumaticos();
          $editarOrdenInspeccionNeumatico -> ctrEditarOrdenInspeccionNeumatico();
...
<!--=====================================
MODAL AGREGAR ELEMENTO INSPECCION NEUMATICO
======================================-->
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
          ...
          <div class="box-body">           
            ...
            <div class="form-group">              
              ...
              <div class="input-group">              
                ...
                <input type="text" class="form-control input-lg" name="nuevoObservaciones" placeholder="Ingresar Observacion" required>

                <input type="hidden" class="form-control" name="nuevoOrdenInspeccionNeumatico" value="<?php echo $_GET['idOrdenInspeccionNeumatico']; ?>" readonly>
      ...
      <?php
          ...
          $crearOrdenInspeccionNeumatico = new ControladorOrdenesInspeccionesNeumaticos();
          $crearOrdenInspeccionNeumatico -> ctrCrearOrdenInspeccionNeumatico();
