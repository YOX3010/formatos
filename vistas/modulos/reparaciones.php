  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body">
       ...
       <table class="table table-bordered table-striped dt-responsive tablaReparaciones" width="100%">
       ...
       <input type="hidden" value="<?php echo $_SESSION['perfil']; ?>" id="perfilOculto2">
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <?php
          ...
          $crearProducto = new ControladorReparaciones();
          $crearProducto -> ctrCrearReparacion();
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <?php
          ...
          $editarProducto = new ControladorReparaciones();
          $editarProducto -> ctrEditarReparacion();
...
<?php
  ...
  $eliminarProducto = new ControladorReparaciones();
  $eliminarProducto -> ctrEliminarReparacion();
