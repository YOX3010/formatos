...
<div class="content-wrapper">
  ...
  <section class="content-header">    
    ...
    <h1> Administrar Marcas de Vehiculos </h1>

    <ol class="breadcrumb">      

      <li><a href="inicio"><i class="fa fa-dashboard"></i> Inicio</a></li>      

      <li class="active">Administrar Marcas de Vehiculos</li>    
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
        ...
        <div class="modal-header" style="background:#3c8dbc; color:white">
          ...
          <h4 class="modal-title">Agregar Marca de Vehiculo</h4>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevoMarca" placeholder="Ingresar Marca Vehiculo" required>
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary">Guardar Marca Vehiculo</button>
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
        ...
        <div class="modal-header" style="background:#3c8dbc; color:white">
          ...
          <h4 class="modal-title">Editar Marca Vehiculo</h4>
