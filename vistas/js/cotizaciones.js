...
$(".tablaCotizaciones tbody").on("click", "button.agregarProducto", function(){
...
$("#nuevoMetodoPago").change(function(){
	...
	if(metodo == "Efectivo"){
		...
		if((metodo == "TC") || (metodo == "TD") || (metodo == "Transferencia")) {
...
function listarMetodos(){
	...
	if($("#nuevoMetodoPago").val() == "Efectivo"){
		...
		if($("#nuevoMetodoPago").val() == "CXC"){

		$("#listaMetodoPago").val("CXC");
